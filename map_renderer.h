...
namespace renderer {
    ...
    public:
        ...
        std::vector<svg::Polyline> GetBusLines(const std::map<std::string, domain::Bus>& buses, const SphereProjector& sp) const;

        std::vector<svg::Text> GetBusLabels(const std::map<std::string, domain::Bus>& buses, const SphereProjector& sp) const;

        std::vector<svg::Text> GetStopLabels(const std::map<std::string, domain::Stop>& stops, const SphereProjector& sp) const;
